...
Last Updated: 7/3/2025, 12:25:28 PM
...
| oscd-shell | ❌ | 1 | 2 | 0 |
| | | [docs: Theming - document the intended mapping from solarized variable names to MWC and MD variable names](https://github.com/OMICRONEnergyOSS/oscd-shell/issues/30) | [Feat add support for background plugins](https://github.com/OMICRONEnergyOSS/oscd-shell/pull/53)<br>[chore(main): release oscd-shell 0.0.6](https://github.com/OMICRONEnergyOSS/oscd-shell/pull/51) | |
